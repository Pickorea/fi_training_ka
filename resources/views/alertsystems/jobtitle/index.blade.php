    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">{{ __('Manage job titles') }}</h3>

                <div class="box-header with-border">
                {{--@can('isUser')--}}
                        <div class="alert alert-info clearfix">
                            <a href="{{ route('jobtitle.create') }}" class="alert-link"><button type="button" class="btn btn-primary btn-sm float-end">{{ __(' Add Job Title') }}</button></a> 
               ...
               <table  class="table table-bordered table-striped">
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            ...
                            <a class="btn btn-info text-center" href="{{route('jobtitle.show', $jobtitle->id)}}">Show</a>      
                               <a href="{{ route('jobtitle.edit', $jobtitle->id) }}"><i class="icon fa fa-edit"></i> {{ __('Edit') }}</a>
