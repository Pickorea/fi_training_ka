                ...
                <!-- Content Header (Page header) -->
                    ...
                    <section class="content">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                            <form method="POST" enctype="multipart/form-data" id="upload-file" action="{{ route('education.store') }}" >
                                                                    @csrf
                                          ...
                                          <h4 class="box-title text-info"> SECTION A</h4>
                                              ...
                                              <div class="row">
                                                   ...
                                                   <select name="employee_id" id="employee_id" class="form-control">
                                                        ...
                                                        <option  value="{{ $keys }}">{{ $employee }}</option>
                                                   ...
                                                   <select name="qualification_id" id="qualification_id" class="form-control">
                                                        ...
                                                        <option value="{{ $keys }}">{{ $qualification}}</option>
                                                        @endforeach
                                                    </select>
                                                   ...
                                                   <select name="school_id" id="school_id" class="form-control">
                                                        ...
                                                        <option value="{{ $keys }}">{{ $school }}</option>
                                                        @endforeach
                                                    </select>
